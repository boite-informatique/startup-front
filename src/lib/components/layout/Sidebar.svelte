...
<div
    class="relative z-50 m-4 mt-6 rounded-lg bg-light bg-opacity-10 capitalize text-gray-900 shadow-lg dark:bg-gray-800 dark:bg-opacity-50 dark:text-gray-50 lg:m-0 lg:w-[22%] lg:rounded-none lg:px-2 lg:py-3 lg:shadow-left"
>
    <div
