...
<input type="checkbox" id="my-modal-124" class="modal-toggle" />
<label for="my-modal-124" class="modal z-[9999] cursor-pointer">
...
<label for="my-modal-124" class="btn-primary btn">Create Announcement</label>
