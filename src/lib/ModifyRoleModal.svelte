...
<div class="modal">
    ...
    >
        ...
        >
            {#if (ModifyRoleModalData.name ? ModifyRoleModalData.name != name : false) || (ModifyRoleModalData.users ? ModifyRoleModalData.users != users : false) || (ModifyRoleModalData.permissions ? ModifyRoleModalData.permissions != permissions : false) || password.length > 0}
                <!-- <button
                    ...
                    >{$_("admin.users.modified informations")}: {ModifyRoleModalData.email
                        ? ModifyRoleModalData.email != email
                            ? "email"
                            : ""
                        : ""}{ModifyRoleModalData.password
                        ? password.length > 0
                            ? `${
                                  ModifyRoleModalData.email != email ? ", " : ""
                              }${$_("admin.users.password")}`
                            : ""
                        : ""}{ModifyRoleModalData.roles
                        ? ModifyRoleModalData.roles != roles
                            ? `${password.length > 0 ? ", " : ""}${$_(
                                  "admin.users.roles"
                              )}`
                            : ""
                        : ""}{ModifyRoleModalData.activated
                        ? ModifyRoleModalData.activated != activated
                            ? `${
                                  ModifyRoleModalData.roles != roles ? ", " : ""
                              }${$_("admin.users.activated")}.`
                            : "."
